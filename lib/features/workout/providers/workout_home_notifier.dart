...
class WorkoutHomeNotifier extends _$WorkoutHomeNotifier {
  ...
  Future<void> logWeight(double weight) async {
    ...
    await repo.addMeasurement(BodyMeasurementsCompanion.insert(
      weight: Value(weight),
      date: DateTime.now(),
    ));
    ref.invalidateSelf();
  ...
  List<MotivationTip> _getMotivationTips() {
    return const [
      MotivationTip(text: "Progressive overload is the key to muscle growth. Always aim to do more than last time.", category: "Progress"),
      MotivationTip(text: "Don't skip leg day. Squats build more than just legs; they boost overall testosterone.", category: "Technique"),
      MotivationTip(text: "Rest is just as important as the workout. Your muscles grow while you sleep.", category: "Recovery"),
      MotivationTip(text: "Consistency over intensity. Showing up every day is better than one perfect workout.", category: "Mindset"),
      MotivationTip(text: "Drink at least 3 liters of water daily to stay hydrated and keep your muscles full.", category: "Nutrition"),
      MotivationTip(text: "Mind-muscle connection: focus on the muscle you're working, don't just move the weight.", category: "Technique"),
      MotivationTip(text: "Form first, weight later. Ego lifting is the fastest way to get an injury.", category: "Safety"),
      MotivationTip(text: "Track your lifts. If you don't measure it, you can't improve it.", category: "Tracking"),
      MotivationTip(text: "A 10-minute workout is better than no workout at all.", category: "Mindset"),
      MotivationTip(text: "Eat enough protein. Aim for 1.6g to 2.2g per kg of body weight.", category: "Nutrition"),
      MotivationTip(text: "Compound movements like deadlifts and presses should be the core of your routine.", category: "Technique"),
      MotivationTip(text: "Listen to your body. If something hurts (not just burn), stop and check your form.", category: "Safety"),
      MotivationTip(text: "Deload weeks are necessary to prevent burnout and central nervous system fatigue.", category: "Recovery"),
      MotivationTip(text: "Your only competition is the person you were yesterday.", category: "Mindset"),
      MotivationTip(text: "Pre-workout caffeine can increase focus and power output.", category: "Supplements"),
      MotivationTip(text: "Stretching after a workout can improve flexibility and blood flow to muscles.", category: "Recovery"),
      MotivationTip(text: "A strong core provides stability for all your other lifts.", category: "Technique"),
      MotivationTip(text: "Don't fear carbs; they are the primary fuel for high-intensity training.", category: "Nutrition"),
      MotivationTip(text: "Visualize your set before you start. Mental preparation increases performance.", category: "Mindset"),
      MotivationTip(text: "Keep your rest periods consistent to properly track progress.", category: "Tracking"),
      MotivationTip(text: "Full range of motion beats partial reps 90% of the time.", category: "Technique"),
      MotivationTip(text: "Creatine is one of the most researched and effective safe supplements.", category: "Supplements"),
      MotivationTip(text: "Vary your rep ranges to target different muscle fiber types.", category: "Progress"),
      MotivationTip(text: "Sleep 7-9 hours per night for optimal recovery and hormone balance.", category: "Recovery"),
      MotivationTip(text: "The last 2 reps are where the growth happens.", category: "Mindset"),
      MotivationTip(text: "Proper breathing: exhale on exertion, inhale on the release.", category: "Technique"),
      MotivationTip(text: "Unilateral training helps correct muscle imbalances.", category: "Technique"),
      MotivationTip(text: "Healthy fats are essential for hormone production and joint health.", category: "Nutrition"),
      MotivationTip(text: "Celebrate the small wins. A 1kg increase is still progress.", category: "Mindset"),
      MotivationTip(text: "Keep your gym bag packed the night before to eliminate excuses.", category: "Mindset"),
    ];
  }
}
