...
final class WorkoutTemplatesProvider
    extends
        $FunctionalProvider<
...
final class TemplateDaysProvider
    extends
        $FunctionalProvider<
  ...
  TemplateDaysProvider._({
    required TemplateDaysFamily super.from,
  ...
  FutureOr<List<ProgramDay>> create(Ref ref) {
    ...
    return templateDays(ref, argument);
  }
...
final class TemplateDaysFamily extends $Family
  ...
  TemplateDaysProvider call(int templateId) =>
