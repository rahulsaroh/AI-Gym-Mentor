...
class _BodyStatsLogScreenState extends ConsumerState<BodyStatsLogScreen> {
  ...
  void _onSave() async {
    ...
    final measurement = ent.BodyMeasurement(
      ...
      waistNaval: double.tryParse(_controllers['waistNaval']!.text),
      ...
      subcutaneousFat: double.tryParse(_controllers['subcutaneousFat']!.text),
      visceralFat: double.tryParse(_controllers['visceralFat']!.text),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'subcutaneousFat')),
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'visceralFat')),
            
            _buildSectionHeader('Upper Body'),
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'neck')),
            ...
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'forearmLeft')),
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'forearmRight')),
            
            _buildSectionHeader('Lower Body'),
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'waist')),
            _buildMetricRow(standardMetrics.firstWhere((m) => m.id == 'waistNaval')),
