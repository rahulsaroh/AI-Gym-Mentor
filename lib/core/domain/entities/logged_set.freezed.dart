...
mixin _$LoggedSet {
 ...
 int get id; int get workoutId; int get exerciseId; int get exerciseOrder; int get setNumber; double get weight; double get reps; double? get rpe; int? get rir; SetType get setType; String? get notes; bool get completed; DateTime? get completedAt; bool get isPr; String? get supersetGroupId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,workoutId,exerciseId,exerciseOrder,setNumber,weight,reps,rpe,rir,setType,notes,completed,completedAt,isPr,supersetGroupId);
...
@useResult
$Res call({
 int id, int workoutId, int exerciseId, int exerciseOrder, int setNumber, double weight, double reps, double? rpe, int? rir, SetType setType, String? notes, bool completed, DateTime? completedAt, bool isPr, String? supersetGroupId
});
...
/// Create a copy of LoggedSet
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? workoutId = null,Object? exerciseId = null,Object? exerciseOrder = null,Object? setNumber = null,Object? weight = null,Object? reps = null,Object? rpe = freezed,Object? rir = freezed,Object? setType = null,Object? notes = freezed,Object? completed = null,Object? completedAt = freezed,Object? isPr = null,Object? supersetGroupId = freezed,}) {
...
as int,exerciseOrder: null == exerciseOrder ? _self.exerciseOrder : exerciseOrder // ignore: cast_nullable_to_non_nullable
...
as SetType,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int workoutId,  int exerciseId,  int exerciseOrder,  int setNumber,  double weight,  double reps,  double? rpe,  int? rir,  SetType setType,  String? notes,  bool completed,  DateTime? completedAt,  bool isPr,  String? supersetGroupId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoggedSet() when $default != null:
return $default(_that.id,_that.workoutId,_that.exerciseId,_that.exerciseOrder,_that.setNumber,_that.weight,_that.reps,_that.rpe,_that.rir,_that.setType,_that.notes,_that.completed,_that.completedAt,_that.isPr,_that.supersetGroupId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int workoutId,  int exerciseId,  int exerciseOrder,  int setNumber,  double weight,  double reps,  double? rpe,  int? rir,  SetType setType,  String? notes,  bool completed,  DateTime? completedAt,  bool isPr,  String? supersetGroupId)  $default,) {final _that = this;
switch (_that) {
case _LoggedSet():
return $default(_that.id,_that.workoutId,_that.exerciseId,_that.exerciseOrder,_that.setNumber,_that.weight,_that.reps,_that.rpe,_that.rir,_that.setType,_that.notes,_that.completed,_that.completedAt,_that.isPr,_that.supersetGroupId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int workoutId,  int exerciseId,  int exerciseOrder,  int setNumber,  double weight,  double reps,  double? rpe,  int? rir,  SetType setType,  String? notes,  bool completed,  DateTime? completedAt,  bool isPr,  String? supersetGroupId)?  $default,) {final _that = this;
switch (_that) {
case _LoggedSet() when $default != null:
return $default(_that.id,_that.workoutId,_that.exerciseId,_that.exerciseOrder,_that.setNumber,_that.weight,_that.reps,_that.rpe,_that.rir,_that.setType,_that.notes,_that.completed,_that.completedAt,_that.isPr,_that.supersetGroupId);case _:
  return null;
...
class _LoggedSet extends LoggedSet {
  const _LoggedSet({required this.id, required this.workoutId, required this.exerciseId, required this.exerciseOrder, required this.setNumber, required this.weight, required this.reps, this.rpe, this.rir, this.setType = SetType.straight, this.notes, this.completed = false, this.completedAt, this.isPr = false, this.supersetGroupId}): super._();
...
/// Create a copy of LoggedSet
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? workoutId = null,Object? exerciseId = null,Object? exerciseOrder = null,Object? setNumber = null,Object? weight = null,Object? reps = null,Object? rpe = freezed,Object? rir = freezed,Object? setType = null,Object? notes = freezed,Object? completed = null,Object? completedAt = freezed,Object? isPr = null,Object? supersetGroupId = freezed,}) {
