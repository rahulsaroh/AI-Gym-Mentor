...
mixin _$WorkoutSession {
 ...
 int get id; String get name; DateTime get date; DateTime? get startTime; DateTime? get endTime; int? get duration; int? get templateId; int? get dayId; String? get notes; String get status; List<LoggedExercise> get exercises;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WorkoutSession&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.date, date) || other.date == date)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.templateId, templateId) || other.templateId == templateId)&&(identical(other.dayId, dayId) || other.dayId == dayId)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.exercises, exercises));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,date,startTime,endTime,duration,templateId,dayId,notes,status,const DeepCollectionEquality().hash(exercises));
...
@useResult
$Res call({
 int id, String name, DateTime date, DateTime? startTime, DateTime? endTime, int? duration, int? templateId, int? dayId, String? notes, String status, List<LoggedExercise> exercises
});
...
/// Create a copy of WorkoutSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? date = null,Object? startTime = freezed,Object? endTime = freezed,Object? duration = freezed,Object? templateId = freezed,Object? dayId = freezed,Object? notes = freezed,Object? status = null,Object? exercises = null,}) {
...
as int?,dayId: freezed == dayId ? _self.dayId : dayId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  DateTime date,  DateTime? startTime,  DateTime? endTime,  int? duration,  int? templateId,  int? dayId,  String? notes,  String status,  List<LoggedExercise> exercises)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WorkoutSession() when $default != null:
return $default(_that.id,_that.name,_that.date,_that.startTime,_that.endTime,_that.duration,_that.templateId,_that.dayId,_that.notes,_that.status,_that.exercises);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  DateTime date,  DateTime? startTime,  DateTime? endTime,  int? duration,  int? templateId,  int? dayId,  String? notes,  String status,  List<LoggedExercise> exercises)  $default,) {final _that = this;
switch (_that) {
case _WorkoutSession():
return $default(_that.id,_that.name,_that.date,_that.startTime,_that.endTime,_that.duration,_that.templateId,_that.dayId,_that.notes,_that.status,_that.exercises);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  DateTime date,  DateTime? startTime,  DateTime? endTime,  int? duration,  int? templateId,  int? dayId,  String? notes,  String status,  List<LoggedExercise> exercises)?  $default,) {final _that = this;
switch (_that) {
case _WorkoutSession() when $default != null:
return $default(_that.id,_that.name,_that.date,_that.startTime,_that.endTime,_that.duration,_that.templateId,_that.dayId,_that.notes,_that.status,_that.exercises);case _:
  return null;
...
class _WorkoutSession extends WorkoutSession {
  const _WorkoutSession({required this.id, required this.name, required this.date, this.startTime, this.endTime, this.duration, this.templateId, this.dayId, this.notes, this.status = 'draft', final  List<LoggedExercise> exercises = const []}): _exercises = exercises,super._();
...
@override@JsonKey() List<LoggedExercise> get exercises {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkoutSession&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.date, date) || other.date == date)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.templateId, templateId) || other.templateId == templateId)&&(identical(other.dayId, dayId) || other.dayId == dayId)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._exercises, _exercises));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,date,startTime,endTime,duration,templateId,dayId,notes,status,const DeepCollectionEquality().hash(_exercises));
...
/// Create a copy of WorkoutSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? date = null,Object? startTime = freezed,Object? endTime = freezed,Object? duration = freezed,Object? templateId = freezed,Object? dayId = freezed,Object? notes = freezed,Object? status = null,Object? exercises = null,}) {
...
mixin _$LoggedExercise {
 ...
 int get exerciseId; String get exerciseName; int get order; List<LoggedSet> get sets;
/// Create a copy of LoggedExercise
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LoggedExerciseCopyWith<LoggedExercise> get copyWith => _$LoggedExerciseCopyWithImpl<LoggedExercise>(this as LoggedExercise, _$identity);
...
abstract mixin class $LoggedExerciseCopyWith<$Res>  {
  factory $LoggedExerciseCopyWith(LoggedExercise value, $Res Function(LoggedExercise) _then) = _$LoggedExerciseCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LoggedExercise value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LoggedExercise value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LoggedExercise value)?  $default,){
final _that = this;
switch (_that) {
case _LoggedExercise() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int exerciseId,  String exerciseName,  int order,  List<LoggedSet> sets)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoggedExercise() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int exerciseId,  String exerciseName,  int order,  List<LoggedSet> sets)  $default,) {final _that = this;
switch (_that) {
case _LoggedExercise():
return $default(_that.exerciseId,_that.exerciseName,_that.order,_that.sets);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int exerciseId,  String exerciseName,  int order,  List<LoggedSet> sets)?  $default,) {final _that = this;
switch (_that) {
case _LoggedExercise() when $default != null:
return $default(_that.exerciseId,_that.exerciseName,_that.order,_that.sets);case _:
  return null;
...
class _LoggedExercise extends LoggedExercise {
  const _LoggedExercise({required this.exerciseId, required this.exerciseName, required this.order, final  List<LoggedSet> sets = const []}): _sets = sets,super._();
  factory _LoggedExercise.fromJson(Map<String, dynamic> json) => _$LoggedExerciseFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$LoggedExerciseCopyWith<_LoggedExercise> get copyWith => __$LoggedExerciseCopyWithImpl<_LoggedExercise>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LoggedExerciseToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoggedExercise&&(identical(other.exerciseId, exerciseId) || other.exerciseId == exerciseId)&&(identical(other.exerciseName, exerciseName) || other.exerciseName == exerciseName)&&(identical(other.order, order) || other.order == order)&&const DeepCollectionEquality().equals(other._sets, _sets));
}
...
/// @nodoc
abstract mixin class _$LoggedExerciseCopyWith<$Res> implements $LoggedExerciseCopyWith<$Res> {
  factory _$LoggedExerciseCopyWith(_LoggedExercise value, $Res Function(_LoggedExercise) _then) = __$LoggedExerciseCopyWithImpl;
@override @useResult
$Res call({
 int exerciseId, String exerciseName, int order, List<LoggedSet> sets
});
