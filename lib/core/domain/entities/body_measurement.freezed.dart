...
mixin _$BodyMeasurement {
 ...
 int get id; DateTime get date; double? get weight; double? get bodyFat; double? get neck; double? get chest; double? get shoulders; double? get armLeft; double? get armRight; double? get forearmLeft; double? get forearmRight; double? get waist; double? get waistNaval; double? get hips; double? get thighLeft; double? get thighRight; double? get calfLeft; double? get calfRight; double? get height; double? get subcutaneousFat; double? get visceralFat; Map<String, double>? get customValues; String? get notes;
...
@useResult
$Res call({
 int id, DateTime date, double? weight, double? bodyFat, double? neck, double? chest, double? shoulders, double? armLeft, double? armRight, double? forearmLeft, double? forearmRight, double? waist, double? waistNaval, double? hips, double? thighLeft, double? thighRight, double? calfLeft, double? calfRight, double? height, double? subcutaneousFat, double? visceralFat, Map<String, double>? customValues, String? notes
});
...
/// Create a copy of BodyMeasurement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? date = null,Object? weight = freezed,Object? bodyFat = freezed,Object? neck = freezed,Object? chest = freezed,Object? shoulders = freezed,Object? armLeft = freezed,Object? armRight = freezed,Object? forearmLeft = freezed,Object? forearmRight = freezed,Object? waist = freezed,Object? waistNaval = freezed,Object? hips = freezed,Object? thighLeft = freezed,Object? thighRight = freezed,Object? calfLeft = freezed,Object? calfRight = freezed,Object? height = freezed,Object? subcutaneousFat = freezed,Object? visceralFat = freezed,Object? customValues = freezed,Object? notes = freezed,}) {
...
as double?,waistNaval: freezed == waistNaval ? _self.waistNaval : waistNaval // ignore: cast_nullable_to_non_nullable
...
as double?,subcutaneousFat: freezed == subcutaneousFat ? _self.subcutaneousFat : subcutaneousFat // ignore: cast_nullable_to_non_nullable
as double?,visceralFat: freezed == visceralFat ? _self.visceralFat : visceralFat // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  DateTime date,  double? weight,  double? bodyFat,  double? neck,  double? chest,  double? shoulders,  double? armLeft,  double? armRight,  double? forearmLeft,  double? forearmRight,  double? waist,  double? waistNaval,  double? hips,  double? thighLeft,  double? thighRight,  double? calfLeft,  double? calfRight,  double? height,  double? subcutaneousFat,  double? visceralFat,  Map<String, double>? customValues,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BodyMeasurement() when $default != null:
return $default(_that.id,_that.date,_that.weight,_that.bodyFat,_that.neck,_that.chest,_that.shoulders,_that.armLeft,_that.armRight,_that.forearmLeft,_that.forearmRight,_that.waist,_that.waistNaval,_that.hips,_that.thighLeft,_that.thighRight,_that.calfLeft,_that.calfRight,_that.height,_that.subcutaneousFat,_that.visceralFat,_that.customValues,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  DateTime date,  double? weight,  double? bodyFat,  double? neck,  double? chest,  double? shoulders,  double? armLeft,  double? armRight,  double? forearmLeft,  double? forearmRight,  double? waist,  double? waistNaval,  double? hips,  double? thighLeft,  double? thighRight,  double? calfLeft,  double? calfRight,  double? height,  double? subcutaneousFat,  double? visceralFat,  Map<String, double>? customValues,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _BodyMeasurement():
return $default(_that.id,_that.date,_that.weight,_that.bodyFat,_that.neck,_that.chest,_that.shoulders,_that.armLeft,_that.armRight,_that.forearmLeft,_that.forearmRight,_that.waist,_that.waistNaval,_that.hips,_that.thighLeft,_that.thighRight,_that.calfLeft,_that.calfRight,_that.height,_that.subcutaneousFat,_that.visceralFat,_that.customValues,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  DateTime date,  double? weight,  double? bodyFat,  double? neck,  double? chest,  double? shoulders,  double? armLeft,  double? armRight,  double? forearmLeft,  double? forearmRight,  double? waist,  double? waistNaval,  double? hips,  double? thighLeft,  double? thighRight,  double? calfLeft,  double? calfRight,  double? height,  double? subcutaneousFat,  double? visceralFat,  Map<String, double>? customValues,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _BodyMeasurement() when $default != null:
return $default(_that.id,_that.date,_that.weight,_that.bodyFat,_that.neck,_that.chest,_that.shoulders,_that.armLeft,_that.armRight,_that.forearmLeft,_that.forearmRight,_that.waist,_that.waistNaval,_that.hips,_that.thighLeft,_that.thighRight,_that.calfLeft,_that.calfRight,_that.height,_that.subcutaneousFat,_that.visceralFat,_that.customValues,_that.notes);case _:
  return null;
...
class _BodyMeasurement extends BodyMeasurement {
  const _BodyMeasurement({required this.id, required this.date, this.weight, this.bodyFat, this.neck, this.chest, this.shoulders, this.armLeft, this.armRight, this.forearmLeft, this.forearmRight, this.waist, this.waistNaval, this.hips, this.thighLeft, this.thighRight, this.calfLeft, this.calfRight, this.height, this.subcutaneousFat, this.visceralFat, final  Map<String, double>? customValues, this.notes}): _customValues = customValues,super._();
...
@override final  double? waistNaval;
...
@override final  double? subcutaneousFat;
@override final  double? visceralFat;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BodyMeasurement&&(identical(other.id, id) || other.id == id)&&(identical(other.date, date) || other.date == date)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.bodyFat, bodyFat) || other.bodyFat == bodyFat)&&(identical(other.neck, neck) || other.neck == neck)&&(identical(other.chest, chest) || other.chest == chest)&&(identical(other.shoulders, shoulders) || other.shoulders == shoulders)&&(identical(other.armLeft, armLeft) || other.armLeft == armLeft)&&(identical(other.armRight, armRight) || other.armRight == armRight)&&(identical(other.forearmLeft, forearmLeft) || other.forearmLeft == forearmLeft)&&(identical(other.forearmRight, forearmRight) || other.forearmRight == forearmRight)&&(identical(other.waist, waist) || other.waist == waist)&&(identical(other.waistNaval, waistNaval) || other.waistNaval == waistNaval)&&(identical(other.hips, hips) || other.hips == hips)&&(identical(other.thighLeft, thighLeft) || other.thighLeft == thighLeft)&&(identical(other.thighRight, thighRight) || other.thighRight == thighRight)&&(identical(other.calfLeft, calfLeft) || other.calfLeft == calfLeft)&&(identical(other.calfRight, calfRight) || other.calfRight == calfRight)&&(identical(other.height, height) || other.height == height)&&(identical(other.subcutaneousFat, subcutaneousFat) || other.subcutaneousFat == subcutaneousFat)&&(identical(other.visceralFat, visceralFat) || other.visceralFat == visceralFat)&&const DeepCollectionEquality().equals(other._customValues, _customValues)&&(identical(other.notes, notes) || other.notes == notes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,date,weight,bodyFat,neck,chest,shoulders,armLeft,armRight,forearmLeft,forearmRight,waist,waistNaval,hips,thighLeft,thighRight,calfLeft,calfRight,height,subcutaneousFat,visceralFat,const DeepCollectionEquality().hash(_customValues),notes]);
