...
void main() {
  ...
  test('End-to-End Workflow: 6 Days Demo Plan', () async {
    ...
    final templateId = await db.into(db.workoutTemplates).insert(const WorkoutTemplatesCompanion(
    ...
    expect(history.first['volume'], 60.0 * 10 * 6); // 2 exercises * 3 sets * 60kg * 10 reps
