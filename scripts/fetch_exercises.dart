...
const String yuhonasUrl = 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/dist/exercises.json';
const String wrkoutApiUrl = 'https://api.github.com/repos/wrkout/exercises.json/contents/exercises';
const String wrkoutBaseRawUrl = 'https://raw.githubusercontent.com/wrkout/exercises.json/master/exercises';
const String exerciseDbMirrorUrl = 'https://raw.githubusercontent.com/ExerciseDB/exercisedb-api/main/db.json'; // Estimated location
...
Future<void> main() async {
  ...
  try {
    ...
    if (listResponse.statusCode == 200) {
      ...
      print('  - Found ${folders.length} folders. Fetching data.json with concurrency...');
      
      const batchSize = 100;
      int processed = 0;
      
      for (var i = 0; i < folders.length; i += batchSize) {
        final end = (i + batchSize < folders.length) ? i + batchSize : folders.length;
  ...
  print('--- Aggregation Complete. Total raw exercises: ${allExercises.length} ---');
  ...
  print('--- Deduplication Complete. Total unique exercises: ${finalData.length} ---');
...
Map<String, dynamic> normalizeYuhonas(Map<String, dynamic> item) {
  ...
  return {
    ...
    'imageUrl': 'https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/$id/0.jpg',
    'videoUrl': null,
...
Map<String, dynamic> normalizeWrkout(Map<String, dynamic> item, String folderName) {
  return {
